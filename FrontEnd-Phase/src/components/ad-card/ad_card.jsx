import style from "./ad_card.module.css"
                ...
                <div className="col-9" id={style.info}>
                    <div className="row">
                        ...
                        <div className="col-lg-4 col-md-5 col-6 row" id={style.edit}>
                            <a href="#" className={`col-6 ${style.edit_tag}`}><i className="bi bi-pencil"></i></a>
                            <a href="#" className={`col-6 ${style.edit_tag}`}><i className="bi bi-trash"></i></a>
                        </div>
                    </div>
