import style from "./sell_card.module.css"
        ...
        <div className="col-lg-6 col-12 p-3" id={style.card_container}>
            ...
            <div className=" d-flex h-100" id={style.card_d}>
                ...
                <div className="col-9" id={style.info}>
                    ...
                    <pre id={style.reaction}>بازخورد خریدار ثبت شد: <a href="#">مشاهده بازخورد</a></pre>
                    <p id={style.no_reaction}>خریدار هنوز بازخوردی ثبت نکرده است</p>
                </div>
            </div>
            </a>
